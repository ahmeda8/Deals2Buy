...
namespace Deals2Buy
{
    class Deals2Buy : BaseWebGet
    {
        private ObservableCollection<PivotModel> _DataCollection;
        public bool Completed = false;
        private int CompletedCount = 0;

        public Deals2Buy(ObservableCollection<PivotModel> DataContextUpdateable)
        {
        ...
        public void Start()
        {
            if (!Completed)
            {
                ...
                CompletedCount = 0;
                _DataCollection.Add(new PivotModel { Header = "all deals", Url = "http://www.deals2buy.com/rssgen/alldeals.xml", DataCollection = new ObservableCollection<DisplayModel>() });
